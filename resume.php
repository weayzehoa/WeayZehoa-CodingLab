...
<body data-spy="scroll" data-target="#myScrollspy" data-offset="1">
	...
	<div id="resume_professional" class="container padding-top vh-100 col-6 offset-4 bg-white text-dark">
		...
		<br>
		<div class="row vh-25">
			<div id="resume_professional_1" class="col-5 offset-1 ">
	...
	<div id="resume_skills" class="container padding-top vh-100 col-6 offset-4 bg-white text-dark">
		...
		<br>
		<div class="row">
			<div id="resume_skills_1" class="col-5 offset-1 vh-30 bg-white">
				<h4><i class="fas fa-code text-warning"></i></i>&nbsp;網頁設計</h4>
				<div class="col-12">
					...
					<div class="animate-box" data-animate-effect="fadeInLeft">
						<div class="progress-wrap">
							<h5>Dreamweaver</h5>
							<div class="progress">
								<div class="progress-bar color-5" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"
								 style="width:60%">
									<span>60%</span>
								</div>
							</div>
			...
			<div id="resume_skills_2" class="col-5 vh-30 bg-white">
				...
				<div class="col-12">
					<div class="animate-box" data-animate-effect="fadeInLeft">
						<div class="progress-wrap">
							<h5>PHP & MySQL</h5>
							<div class="progress">
								<div class="progress-bar color-1" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"
								 style="width:80%">
									<span>80%</span>
								</div>
							</div>
			...
			<div id="resume_skills_3" class="col-5 offset-1 vh-25 bg-white">
				<h4><i class="fas fa-network-wired text-danger"></i></i>&nbsp;網路管理</h4>
				<div class="col-12">
					<div class="animate-box" data-animate-effect="fadeInLeft">
						<div class="progress-wrap">
			...
			<div id="resume_skills_4" class="col-5 vh-25 bg-white">
				<h4><i class="far fa-lightbulb text-primary"></i>&nbsp;產品企劃開發</h4>
				<div class="col-12">
					<div class="animate-box" data-animate-effect="fadeInLeft">
						<div class="progress-wrap">
			...
			<div id="resume_skills_5" class="col-5 offset-1 vh-25 bg-white">
			...
			<div id="resume_skills_6" class="col-5 vh-25 bg-white">
